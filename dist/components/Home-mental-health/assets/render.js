...
define(['knockout', 'jquery', 'css!./styles/design.css'], function (ko, $, css) {
  ...
  var sampleComponentTemplate = 
    '<!-- ko if: initialized -->' +
    '<div class="container-breakout pt-lg-5 home-mental-health-top">' +
    ...
    '      <div class="col-12">' +
    '        <!-- ko if: linkText -->' +
    '          <a data-bind="attr: { href: linkURL}" class="mt-5 btn btn-lead btn-primary"><span data-bind="text: linkText"></span></a>'  +
    '        <!-- /ko -->' +
    '      </div>' +
    '    </div>' +
    '  </div>' +
