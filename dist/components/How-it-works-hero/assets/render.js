...
define(['knockout', 'jquery'], function (ko, $) {
  ...
  var sampleComponentTemplate =
    '<!-- ko if: initialized -->' +
    '<div class="container-breakout py-4 how-it-works-hero">' +
    '  <div class="container">' +
    '    <div class="row">' +
    '      <div class="col">' +
    ...
    '        <!-- ko if: linkText -->' +
    '          <a data-bind="attr: { href: linkURL}" class="btn btn-lg btn-primary mt-3"><span data-bind="text: linkText"></span></a>'  +
    '        <!-- /ko -->' +
    '      </div>' +
    '    </div>' +
    '  </div>' +
